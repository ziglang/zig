...
def _init_posix():
    ...
    # CPython: _sysconfigdata_* is generated at build time, see sysconfig
    ...
    _config_vars.update(_temp.build_time_vars)
...
def get_config_vars(*args):
    ...
    if not _config_vars:
        ...
        if sys.implementation.name == 'pypy':
            # This is all meaningless on PyPy, skip it
            pass
        elif os.name == 'posix':
            if python_build:
