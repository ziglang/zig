# -*- coding: utf-8 -*-
#
# RPython documentation build configuration file, created by
...
latex_documents = [
  ('index', 'RPython.tex', u'RPython Documentation',
...
man_pages = [
    ('index', 'rpython', u'RPython Documentation',
...
texinfo_documents = [
  ('index', 'RPython', u'RPython Documentation',
   u'The PyPy Project', 'RPython', 'One line description of project.',
   'Miscellaneous'),
]
