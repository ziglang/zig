...
def __lldb_init_module(debugger, _=None):
    ...
    add(debugger, category='zig.stage2', type='Module.Decl::InternPool.DeclIndex', synth=True)
    add(debugger, category='zig.stage2', type='Module.Namespace::InternPool.NamespaceIndex', synth=True)
