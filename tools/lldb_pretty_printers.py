...
def __lldb_init_module(debugger, _=None):
    ...
    add(debugger, category='zig.stage2', type='Zcu.Decl::Zcu.Decl.Index', synth=True)
    add(debugger, category='zig.stage2', type='Zcu.Namespace::Zcu.Namespace.Index', synth=True)
    add(debugger, category='zig.stage2', type='Zcu.LazySrcLoc', identifier='zig_TaggedUnion', synth=True)
