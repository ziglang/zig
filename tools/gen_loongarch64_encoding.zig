...
pub fn main() anyerror!void {
    ...
    defer zig_dir.close();
    const out_file = try zig_dir.createFile("src/arch/loongarch64/encoding.zig", .{});
...
fn usageAndExit(arg0: []const u8, code: u8) noreturn {
    ...
    stderr.writer().print(
        ...
        \\
        \\Updates src/arch/loongarch64/encoding.zig from https://github.com/loongson-community/loongarch-opcodes.git.
        \\
