...
pub const EDQUOT = 69; // Disk quota exceeded
...
pub const EPROGUNAVAIL = 74; // RPC program not available
...
pub const EBADMSG = 92; // Bad message
...
pub const ELAST = 95; // Must be equal largest errno
pub const ERESTART = -1; // restart syscall
pub const EJUSTRETURN = -2; // don't modify regs, just return
