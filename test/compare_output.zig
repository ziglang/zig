...
pub fn addCases(cases: *tests.CompareOutputContext) void {
    ...
    cases.addC("number literals",
        ...
        \\         @as(f64, 0.0e0));
        \\    _ = c.printf("100000000000000000000000000000000000000000000000000000000.0e0: %.013a\n",
        \\         @as(f64, 100000000000000000000000000000000000000000000000000000000.0e0));
    ...
    ,
        ...
        \\100000000000000000000000000000000000000000000000000000000.0e0: 0x1.05031e2503da8p+186
