...
fn testEnum() void {
    ...
    assertOrPanic(os_info.Enum.fields.len == 32);
    assertOrPanic(mem.eql(u8, os_info.Enum.fields[1].name, "ananas"));
    assertOrPanic(os_info.Enum.fields[10].value == 10);
    assertOrPanic(os_info.Enum.tag_type == u5);
