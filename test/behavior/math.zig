...
test "comptime_int addition" {
    comptime {
        ...
        var x = 0;
        x = 65534;
        try expect(x + 1 == 65535);
        try expect(x + 2 == 65536);
        x = 32766;
        try expect(x + 1 == 32767);
        try expect(x + 2 == 32768);
        x = 4294967294;
        try expect(x + 1 == 4294967295);
        try expect(x + 2 == 4294967296);
        x = 2147483646;
        try expect(x + 1 == 2147483647);
        try expect(x + 2 == 2147483648);
        x = 18446744073709551614;
        try expect(x + 1 == 18446744073709551615);
        try expect(x + 2 == 18446744073709551616);
        x = 9223372036854775806;
        try expect(x + 1 == 9223372036854775807);
        try expect(x + 2 == 9223372036854775808);
        x = -32767;
        try expect(x - 1 == -32768);
        try expect(x - 2 == -32769);
        x = -2147483647;
        try expect(x - 1 == -2147483648);
        try expect(x - 2 == -2147483649);
        x = -9223372036854775807;
        try expect(x - 1 == -9223372036854775808);
        try expect(x - 2 == -9223372036854775809);
    }
}
