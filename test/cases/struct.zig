...
test "packed array 24bits" {
    ...
    ptr.a = std.math.maxInt(u16);
    assert(ptr.a == std.math.maxInt(u16));
    assert(ptr.b[0].field == 0);
    assert(ptr.b[1].field == 0);
    assert(ptr.c == 0);

    ptr.b[0].field = std.math.maxInt(u24);
    assert(ptr.a == std.math.maxInt(u16));
    assert(ptr.b[0].field == std.math.maxInt(u24));
    assert(ptr.b[1].field == 0);
    assert(ptr.c == 0);

    ptr.b[1].field = std.math.maxInt(u24);
    assert(ptr.a == std.math.maxInt(u16));
    assert(ptr.b[0].field == std.math.maxInt(u24));
    assert(ptr.b[1].field == std.math.maxInt(u24));
    assert(ptr.c == 0);

    ptr.c = std.math.maxInt(u16);
    assert(ptr.a == std.math.maxInt(u16));
    assert(ptr.b[0].field == std.math.maxInt(u24));
    assert(ptr.b[1].field == std.math.maxInt(u24));
    assert(ptr.c == std.math.maxInt(u16));
