...
// tmp.zig:9:16: error: call to generic function with Null return type '@TypeOf(null)' not allowed
// tmp.zig:2:1: note: function declared here
// tmp.zig:12:16: error: call to generic function with Undefined return type '@TypeOf(undefined)' not allowed
// tmp.zig:2:1: note: function declared here
