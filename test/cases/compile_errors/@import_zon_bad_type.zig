...
// neg_inf.zon:1:1: error: expected type 'tmp.testNonExhaustiveEnum__enum_/?/'
// tmp.zig:62:39: note: imported here
// neg_inf.zon:1:1: error: expected type 'tmp.testUntaggedUnion__union_/?/'
// tmp.zig:67:44: note: imported here
// neg_inf.zon:1:1: error: expected type 'tmp.testTaggedUnionVoid__union_/?/'
