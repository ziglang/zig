...
pub fn testZigInstallPrefix(allocator: var, test_path: []const u8) ![]u8 {
...
/// Caller must free result
pub fn findZigLibDir(allocator: var) ![]u8 {
...
pub fn resolveZigLibDir(allocator: var) ![]u8 {
...
/// Caller must free result
pub fn resolveZigCacheDir(allocator: var) ![]u8 {
