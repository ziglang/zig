...
pub const Type = struct {
    ...
    pub const Struct = struct {
        ...
        pub fn getLlvmType(self: *Struct, allocator: var, llvm_context: *llvm.Context) *llvm.Type {
            @panic("TODO");
        }
    };
    ...
    pub const Fn = struct {
        ...
        pub fn getLlvmType(self: *Fn, allocator: var, llvm_context: *llvm.Context) !*llvm.Type {
    ...
    pub const Bool = struct {
        ...
        pub fn getLlvmType(self: *Bool, allocator: var, llvm_context: *llvm.Context) *llvm.Type {
            @panic("TODO");
        }
    };
    ...
    pub const Int = struct {
        ...
        pub fn getLlvmType(self: *Int, allocator: var, llvm_context: *llvm.Context) !*llvm.Type {
    ...
    pub const Float = struct {
        ...
        pub fn getLlvmType(self: *Float, allocator: var, llvm_context: *llvm.Context) *llvm.Type {
            @panic("TODO");
        }
    };
    pub const Pointer = struct {
        ...
        pub fn getLlvmType(self: *Pointer, allocator: var, llvm_context: *llvm.Context) !*llvm.Type {
    ...
    pub const Array = struct {
        ...
        pub fn getLlvmType(self: *Array, allocator: var, llvm_context: *llvm.Context) !*llvm.Type {
    ...
    pub const Vector = struct {
        ...
        pub fn getLlvmType(self: *Vector, allocator: var, llvm_context: *llvm.Context) *llvm.Type {
            @panic("TODO");
        }
    };
    ...
    pub const Optional = struct {
        ...
        pub fn getLlvmType(self: *Optional, allocator: var, llvm_context: *llvm.Context) *llvm.Type {
            @panic("TODO");
        }
    };
    ...
    pub const ErrorUnion = struct {
        ...
        pub fn getLlvmType(self: *ErrorUnion, allocator: var, llvm_context: *llvm.Context) *llvm.Type {
            @panic("TODO");
        }
    };
    ...
    pub const ErrorSet = struct {
        ...
        pub fn getLlvmType(self: *ErrorSet, allocator: var, llvm_context: *llvm.Context) *llvm.Type {
            @panic("TODO");
        }
    };
    ...
    pub const Enum = struct {
        ...
        pub fn getLlvmType(self: *Enum, allocator: var, llvm_context: *llvm.Context) *llvm.Type {
            @panic("TODO");
        }
    };
    ...
    pub const Union = struct {
        ...
        pub fn getLlvmType(self: *Union, allocator: var, llvm_context: *llvm.Context) *llvm.Type {
            @panic("TODO");
        }
    };
    ...
    pub const BoundFn = struct {
        ...
        pub fn getLlvmType(self: *BoundFn, allocator: var, llvm_context: *llvm.Context) *llvm.Type {
            @panic("TODO");
        }
    };
    ...
    pub const Opaque = struct {
        ...
        pub fn getLlvmType(self: *Opaque, allocator: var, llvm_context: *llvm.Context) *llvm.Type {
            @panic("TODO");
        }
    };
    ...
    pub const Promise = struct {
        ...
        pub fn getLlvmType(self: *Promise, allocator: var, llvm_context: *llvm.Context) *llvm.Type {
            @panic("TODO");
        }
    };
};
