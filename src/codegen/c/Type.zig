...
pub const Pool = struct {
    ...
    pub fn fromType(
        ...
        switch (ty.toIntern()) {
            ...
            .u16_type => return .u16,
            .i16_type => return .i16,
            .u24_type => return if (is_ez80) .u24 else .u32,
            .i24_type => return if (is_ez80) .i24 else .i32,
            .u29_type, .u32_type => return .u32,
            .i32_type => return .i32,
            .u48_type => return if (is_ez80) .u48 else .u64,
            .i48_type => return if (is_ez80) .i48 else .i64,
            .u64_type => return .u64,
            .i64_type => return .i64,
