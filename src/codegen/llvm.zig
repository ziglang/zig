...
pub const Object = struct {
    ...
    pub fn lowerDebugType(
        ...
        const file = if (owner_decl) |owner|
            try o.getDebugFile(mod.namespacePtr(owner.src_namespace).file_scope) else .none;
    ...
    fn genNamespaces(o: *Object) !void {
        ...
        while (i < o.debug_unresolved_namespace_scopes.count()) : (i += 1) {
            ...
            const namespace = o.module.namespacePtr(namespace_index);
            const debug_type = try o.lowerDebugType(namespace.getType(o.module));
...
//                 const static_decl =
//                     if (debug_scope == debug_file) .none
//                     else try o.builder.debugStaticMemberType(
//                         name,
//                         debug_file,
//                         debug_scope,
//                         line_number,
