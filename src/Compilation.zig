...
pub const FileLanguage = enum {
    ...
    preprocessed_hip,
    objective_c,
    preprocessed_objective_c,
    cpp,
    preprocessed_cpp,
    objective_cpp,
    preprocessed_objective_cpp,
    c_header,
    cl_header,
    objective_c_header,
    cpp_module,
    ...
    pub fn toFileExt(lang: FileLanguage) FileExt {
        return switch (lang) {
            .assembly => .assembly,
            .c => .c,
            .preprocessed_c => .i,
            .cl => .cl,
            .cuda, .hip => .cu,
            .preprocessed_cuda, .preprocessed_hip => .cui,
            .objective_c => .m,
            .preprocessed_objective_c => .mi,
            .cpp => .cpp,
            .preprocessed_cpp => .ii,
            .objective_cpp => .mm,
            .preprocessed_objective_cpp => .mii,
            .c_header, .cl_header, .objective_c_header => .h,
            .cpp_module => .cppm,
            .ast => .ast,
            .module_file => .pcm,
            .llvm_ir => .ll,
