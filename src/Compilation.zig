...
pub fn saveState(comp: *Compilation) !void {
    var bufs_list: [19]std.io.WriteBuffers = undefined;
...
fn addBuf(bufs_list: []std.io.WriteBuffers, bufs_len: *usize, buf: []const u8) void {
    const i = bufs_len.*;
    bufs_len.* = i + 1;
    bufs_list[i] = .{
        .ptr = buf.ptr,
...
fn docsCopyFallible(comp: *Compilation) anyerror!void {
    ...
    while (try walker.next()) |entry| {
        ...
        var header_and_trailer: [2]std.io.WriteBuffers = .{
