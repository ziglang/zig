...
pub fn renderAsText(gpa: Allocator, scope_file: *Zcu.File, bw: *std.io.BufferedWriter) anyerror!void {
...
const Writer = struct {
    ...
    fn writeSrcNode(self: *Writer, stream: *std.io.BufferedWriter, src_node: i32) !void {
    ...
    fn writeSrcTok(self: *Writer, stream: *std.io.BufferedWriter, src_tok: u32) !void {
        const tree = self.file.tree orelse return;
    ...
    fn writeSrcTokAbs(self: *Writer, stream: *std.io.BufferedWriter, src_tok: u32) !void {
        const tree = self.file.tree orelse return;
