...
///
/// This is a flat array containing all imports outside of a module root. It is
/// cleared and recomputed on every update. The errors here are fatal, i.e. they
/// block any semantic analysis this update.
///
/// Allocated into gpa.
