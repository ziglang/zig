...
pub const panic = if (build_options.enable_debug_extensions) compilerPanic else std.debug.panicImpl;
pub const panicNew = if (build_options.enable_debug_extensions) compilerPanicNew else std.builtin.panicNew;
