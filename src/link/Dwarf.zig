            ...
            break :blk .{
                ...
                if (real_decl.linkage != .@"extern" or
                    ...
                    Zir.Inst.Declaration.Unwrapped{
                        ...
                        .linkage = .@"extern",
                        .lib_name = real_decl.lib_name,
                        .type_body = real_decl.type_body,
                        .align_body = real_decl.align_body,
                        .linksection_body = real_decl.linksection_body,
                        .addrspace_body = real_decl.addrspace_body,
                        .value_body = real_decl.value_body,
                    }
                else
                    real_decl,
                is_func,
