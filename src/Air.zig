...
pub const Inst = struct {
    ...
    pub const Ref = enum(u32) {
        ...
        u24_type = @intFromEnum(InternPool.Index.u24_type),
        i24_type = @intFromEnum(InternPool.Index.i24_type),
        ...
        u48_type = @intFromEnum(InternPool.Index.u48_type),
        i48_type = @intFromEnum(InternPool.Index.i48_type),
