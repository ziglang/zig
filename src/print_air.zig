...
pub fn write(stream: *std.io.BufferedWriter, pt: Zcu.PerThread, air: Air, liveness: ?Air.Liveness) void {
...
const Writer = struct {
    ...
    fn writeShuffleOne(w: *Writer, s: anytype, inst: Air.Inst.Index) anyerror!void {
    ...
    fn writeTlvDllimportPtr(w: *Writer, s: *std.io.BufferedWriter, inst: Air.Inst.Index) std.io.Writer.Error!void {
    ...
    fn writeAtomicLoad(w: *Writer, s: *std.io.BufferedWriter, inst: Air.Inst.Index) std.io.Writer.Error!void {
