...
pub fn write(stream: *std.io.Writer, pt: Zcu.PerThread, air: Air, liveness: ?Air.Liveness) void {
...
const Writer = struct {
    ...
    fn writeTlvDllimportPtr(w: *Writer, s: *std.io.Writer, inst: Air.Inst.Index) Error!void {
