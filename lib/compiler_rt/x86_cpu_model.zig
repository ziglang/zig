...
comptime {
    ...
    const ignored = std.ComptimeStringMap(void, .{
        // These are not present in std/target/x86.zig because LLVM does
        // not yet define them in llvm/lib/Target/X86/X86.td.
        .{ "avx5124vnniw", {} },
        .{ "avx5124fmaps", {} },
    });
...
// This function should be reviewed after any update to the autogenerated
