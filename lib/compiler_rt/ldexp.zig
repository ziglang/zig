...
test "ldexpf" {
    ...
    try std.testing.expectApproxEqAbs(std.math.maxInt(u32), ldexpf(2, 31), epsilon);
    ...
    try std.testing.expect(math.isNegativeInf(ldexpf(-std.math.inf(f32), -1)));
...
test "ldexp" {
    ...
    try std.testing.expectApproxEqAbs(std.math.maxInt(u64), ldexp(2, 63), epsilon);
    try std.testing.expectApproxEqAbs(std.math.maxInt(u64), ldexp(1, 64), epsilon);
    ...
    try std.testing.expect(math.isNegativeInf(ldexp(-std.math.inf(f64), -1)));
...
test "ldexpl" {
    ...
    try std.testing.expectApproxEqAbs(std.math.maxInt(u128), ldexpl(2, 127), epsilon);
    try std.testing.expectApproxEqAbs(std.math.maxInt(u128), ldexpl(1, 128), epsilon);
    try std.testing.expectApproxEqAbs(0.437500, ldexpl(7, -4), epsilon);
    try std.testing.expectApproxEqAbs(0, ldexpl(0, 10), epsilon);
    try std.testing.expect(math.isNegativeInf(ldexpl(-std.math.inf(f128), -1)));
