...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ID3D11Debug_QueryInterface(ID3D11Debug* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ID3D11Debug_AddRef(ID3D11Debug* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ID3D11Debug_Release(ID3D11Debug* This) {
    return This->lpVtbl->Release(This);
}
/*** ID3D11Debug methods ***/
static __WIDL_INLINE HRESULT ID3D11Debug_SetFeatureMask(ID3D11Debug* This,UINT Mask) {
    return This->lpVtbl->SetFeatureMask(This,Mask);
}
static __WIDL_INLINE UINT ID3D11Debug_GetFeatureMask(ID3D11Debug* This) {
    return This->lpVtbl->GetFeatureMask(This);
}
static __WIDL_INLINE HRESULT ID3D11Debug_SetPresentPerRenderOpDelay(ID3D11Debug* This,UINT Milliseconds) {
    return This->lpVtbl->SetPresentPerRenderOpDelay(This,Milliseconds);
}
static __WIDL_INLINE UINT ID3D11Debug_GetPresentPerRenderOpDelay(ID3D11Debug* This) {
    return This->lpVtbl->GetPresentPerRenderOpDelay(This);
}
static __WIDL_INLINE HRESULT ID3D11Debug_SetSwapChain(ID3D11Debug* This,IDXGISwapChain *pSwapChain) {
    return This->lpVtbl->SetSwapChain(This,pSwapChain);
}
static __WIDL_INLINE HRESULT ID3D11Debug_GetSwapChain(ID3D11Debug* This,IDXGISwapChain **ppSwapChain) {
    return This->lpVtbl->GetSwapChain(This,ppSwapChain);
}
static __WIDL_INLINE HRESULT ID3D11Debug_ValidateContext(ID3D11Debug* This,ID3D11DeviceContext *pContext) {
    return This->lpVtbl->ValidateContext(This,pContext);
}
static __WIDL_INLINE HRESULT ID3D11Debug_ReportLiveDeviceObjects(ID3D11Debug* This,D3D11_RLDO_FLAGS Flags) {
    return This->lpVtbl->ReportLiveDeviceObjects(This,Flags);
}
static __WIDL_INLINE HRESULT ID3D11Debug_ValidateContextForDispatch(ID3D11Debug* This,ID3D11DeviceContext *pContext) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ID3D11SwitchToRef_QueryInterface(ID3D11SwitchToRef* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ID3D11SwitchToRef_AddRef(ID3D11SwitchToRef* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ID3D11SwitchToRef_Release(ID3D11SwitchToRef* This) {
    return This->lpVtbl->Release(This);
}
/*** ID3D11SwitchToRef methods ***/
static __WIDL_INLINE WINBOOL ID3D11SwitchToRef_SetUseRef(ID3D11SwitchToRef* This,WINBOOL useref) {
    return This->lpVtbl->SetUseRef(This,useref);
}
static __WIDL_INLINE WINBOOL ID3D11SwitchToRef_GetUseRef(ID3D11SwitchToRef* This) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ID3D11InfoQueue_QueryInterface(ID3D11InfoQueue* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
...
/*** ID3D11InfoQueue methods ***/
static __WIDL_INLINE HRESULT ID3D11InfoQueue_SetMessageCountLimit(ID3D11InfoQueue* This,UINT64 MessageCountLimit) {
...
static __WIDL_INLINE HRESULT ID3D11InfoQueue_GetMessage(ID3D11InfoQueue* This,UINT64 MessageIndex,D3D11_MESSAGE *pMessage,SIZE_T *pMessageByteLength) {
    return This->lpVtbl->GetMessage(This,MessageIndex,pMessage,pMessageByteLength);
}
static __WIDL_INLINE UINT64 ID3D11InfoQueue_GetNumMessagesAllowedByStorageFilter(ID3D11InfoQueue* This) {
    return This->lpVtbl->GetNumMessagesAllowedByStorageFilter(This);
}
static __WIDL_INLINE UINT64 ID3D11InfoQueue_GetNumMessagesDeniedByStorageFilter(ID3D11InfoQueue* This) {
...
static __WIDL_INLINE UINT64 ID3D11InfoQueue_GetNumStoredMessagesAllowedByRetrievalFilter(ID3D11InfoQueue* This) {
    return This->lpVtbl->GetNumStoredMessagesAllowedByRetrievalFilter(This);
}
static __WIDL_INLINE UINT64 ID3D11InfoQueue_GetNumMessagesDiscardedByMessageCountLimit(ID3D11InfoQueue* This) {
...
static __WIDL_INLINE HRESULT ID3D11InfoQueue_AddStorageFilterEntries(ID3D11InfoQueue* This,D3D11_INFO_QUEUE_FILTER *pFilter) {
    return This->lpVtbl->AddStorageFilterEntries(This,pFilter);
}
static __WIDL_INLINE HRESULT ID3D11InfoQueue_GetStorageFilter(ID3D11InfoQueue* This,D3D11_INFO_QUEUE_FILTER *pFilter,SIZE_T *pFilterByteLength) {
    return This->lpVtbl->GetStorageFilter(This,pFilter,pFilterByteLength);
}
static __WIDL_INLINE void ID3D11InfoQueue_ClearStorageFilter(ID3D11InfoQueue* This) {
...
static __WIDL_INLINE HRESULT ID3D11InfoQueue_PushCopyOfStorageFilter(ID3D11InfoQueue* This) {
    return This->lpVtbl->PushCopyOfStorageFilter(This);
}
static __WIDL_INLINE HRESULT ID3D11InfoQueue_PushStorageFilter(ID3D11InfoQueue* This,D3D11_INFO_QUEUE_FILTER *pFilter) {
...
static __WIDL_INLINE HRESULT ID3D11InfoQueue_AddRetrievalFilterEntries(ID3D11InfoQueue* This,D3D11_INFO_QUEUE_FILTER *pFilter) {
    return This->lpVtbl->AddRetrievalFilterEntries(This,pFilter);
}
static __WIDL_INLINE HRESULT ID3D11InfoQueue_GetRetrievalFilter(ID3D11InfoQueue* This,D3D11_INFO_QUEUE_FILTER *pFilter,SIZE_T *pFilterByteLength) {
...
static __WIDL_INLINE HRESULT ID3D11InfoQueue_PushRetrievalFilter(ID3D11InfoQueue* This,D3D11_INFO_QUEUE_FILTER *pFilter) {
    return This->lpVtbl->PushRetrievalFilter(This,pFilter);
}
static __WIDL_INLINE void ID3D11InfoQueue_PopRetrievalFilter(ID3D11InfoQueue* This) {
...
static __WIDL_INLINE HRESULT ID3D11InfoQueue_AddMessage(ID3D11InfoQueue* This,D3D11_MESSAGE_CATEGORY Category,D3D11_MESSAGE_SEVERITY Severity,D3D11_MESSAGE_ID ID,LPCSTR pDescription) {
    return This->lpVtbl->AddMessage(This,Category,Severity,ID,pDescription);
}
static __WIDL_INLINE HRESULT ID3D11InfoQueue_AddApplicationMessage(ID3D11InfoQueue* This,D3D11_MESSAGE_SEVERITY Severity,LPCSTR pDescription) {
    return This->lpVtbl->AddApplicationMessage(This,Severity,pDescription);
}
static __WIDL_INLINE HRESULT ID3D11InfoQueue_SetBreakOnCategory(ID3D11InfoQueue* This,D3D11_MESSAGE_CATEGORY Category,WINBOOL bEnable) {
    return This->lpVtbl->SetBreakOnCategory(This,Category,bEnable);
}
static __WIDL_INLINE HRESULT ID3D11InfoQueue_SetBreakOnSeverity(ID3D11InfoQueue* This,D3D11_MESSAGE_SEVERITY Severity,WINBOOL bEnable) {
    return This->lpVtbl->SetBreakOnSeverity(This,Severity,bEnable);
}
static __WIDL_INLINE HRESULT ID3D11InfoQueue_SetBreakOnID(ID3D11InfoQueue* This,D3D11_MESSAGE_ID ID,WINBOOL bEnable) {
    return This->lpVtbl->SetBreakOnID(This,ID,bEnable);
}
static __WIDL_INLINE WINBOOL ID3D11InfoQueue_GetBreakOnCategory(ID3D11InfoQueue* This,D3D11_MESSAGE_CATEGORY Category) {
    return This->lpVtbl->GetBreakOnCategory(This,Category);
}
static __WIDL_INLINE WINBOOL ID3D11InfoQueue_GetBreakOnSeverity(ID3D11InfoQueue* This,D3D11_MESSAGE_SEVERITY Severity) {
    return This->lpVtbl->GetBreakOnSeverity(This,Severity);
}
static __WIDL_INLINE WINBOOL ID3D11InfoQueue_GetBreakOnID(ID3D11InfoQueue* This,D3D11_MESSAGE_ID ID) {
    return This->lpVtbl->GetBreakOnID(This,ID);
}
static __WIDL_INLINE void ID3D11InfoQueue_SetMuteDebugOutput(ID3D11InfoQueue* This,WINBOOL bMute) {
