...
#define __AVAILABILITY_INTERNAL__
  ...
  #include <AvailabilityInternalPrivate.h>
    ...
    /* set to 1 when RC_FALLBACK_PLATFORM=iphoneos */
        ...
        #define __TV_OS_VERSION_MAX_ALLOWED __TVOS_16_0
        ...
        #define __WATCH_OS_VERSION_MAX_ALLOWED __WATCHOS_9_0
        /* for compatibility with existing code.  New code should use platform specific checks */
        #define __IPHONE_OS_VERSION_MIN_REQUIRED 90000
    #endif
#endif
        ...
        #define __BRIDGE_OS_VERSION_MAX_ALLOWED 70000
        /* for compatibility with existing code.  New code should use platform specific checks */
    ...
    /* make sure a default max version is set */
        ...
        #define __IPHONE_OS_VERSION_MAX_ALLOWED     __IPHONE_16_0
    #endif
