...
test "cbc encrypt" {
    ...
    const cbc = @import("modes.zig").cbcEncrypt;
    ...
    const ctx = Aes128.initEnc(key);
    cbc(AesEncryptCtx(Aes128), ctx, out[0..], in[0..], iv);
    try testing.expectEqualSlices(u8, exp_out[0..], out[0..]);
}

test "cbc decrypt" {
    // NIST SP 800-38A pp 27-29
    const cbc = @import("modes.zig").cbcDecrypt;
    ...
    cbc(AesDecryptCtx(Aes128), ctx, out[0..], in[0..], iv);
    try testing.expectEqualSlices(u8, exp_out[0..], out[0..]);
}
