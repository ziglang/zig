...
//!
//! At the moment, the longest OID has 171 chars and 34 arcs.
//! The greatest number for an OID arc has 39 digits.
//! This implementation supports any number of arcs but limits values when parsing to `u32`.
