...
fn verifyRsa(
    ...
    const pk = rsa.PublicKey.fromBytes(pk_components.exponent, pk_components.modulus) catch
    ...
    switch (pk_components.modulus.len) {
        inline 128, 256, 384, 512 => |modulus_len| {
            ...
            try rsa.PkcsSignature.verify(modulus_len, sig[0..modulus_len].*, message, pk, Hash);
        },
        else => {
