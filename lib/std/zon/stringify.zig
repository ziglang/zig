...
pub const Serializer = struct {
    ...
    pub const Tuple = struct {
        ...
        fn start(parent: *Serializer, options: SerializeContainerOptions) anyerror!Tuple {
            return .{
        ...
        pub fn finish(self: *Tuple) anyerror!void {
        ...
        /// May return `error.ExceededMaxDepth`.
    ...
    pub const Struct = struct {
        ...
        fn start(parent: *Serializer, options: SerializeContainerOptions) anyerror!Struct {
            return .{
        ...
        ///
        /// Prints a trailing comma as configured when appropriate, and the closing bracket.
        pub fn finish(self: *Struct) anyerror!void {
            try self.container.finish();
            self.* = undefined;
        }
    ...
    const Container = struct {
        ...
        fn start(
            ...
            if (options.shouldWrap()) s.indent_level +|= 1;
        ...
        fn finish(self: *Container) anyerror!void {
...
test "std.zon stringify whitespace, low level API" {
    ...
    for ([2]bool{ true, false }) |whitespace| {
        ...
        // Empty containers
        {
            var container = try s.startStruct(.{});
            try container.finish();
        ...
        {
            var container = try s.startTuple(.{});
            try container.finish();
            try std.testing.expectEqualStrings(".{}", aw.getWritten());
            aw.clearRetainingCapacity();
        }
        ...
        {
            var container = try s.startStruct(.{ .whitespace_style = .{ .wrap = false } });
            try container.finish();
            try std.testing.expectEqualStrings(".{}", aw.getWritten());
            aw.clearRetainingCapacity();
        }
        ...
        {
            var container = try s.startTuple(.{ .whitespace_style = .{ .wrap = false } });
            try container.finish();
            try std.testing.expectEqualStrings(".{}", aw.getWritten());
            aw.clearRetainingCapacity();
        }
        ...
        {
            var container = try s.startStruct(.{ .whitespace_style = .{ .fields = 0 } });
            try container.finish();
            try std.testing.expectEqualStrings(".{}", aw.getWritten());
            aw.clearRetainingCapacity();
        }
        ...
        {
            var container = try s.startTuple(.{ .whitespace_style = .{ .fields = 0 } });
            try container.finish();
            try std.testing.expectEqualStrings(".{}", aw.getWritten());
            aw.clearRetainingCapacity();
        }
        ...
        {
            var container = try s.startStruct(.{ .whitespace_style = .{ .fields = 1 } });
            try container.field("a", 1, .{});
            try container.finish();
            if (whitespace) {
                try std.testing.expectEqualStrings(".{ .a = 1 }", aw.getWritten());
        ...
        {
            var container = try s.startTuple(.{ .whitespace_style = .{ .fields = 1 } });
            try container.field(1, .{});
            try container.finish();
            try std.testing.expectEqualStrings(".{1}", aw.getWritten());
            aw.clearRetainingCapacity();
        ...
        {
            var container = try s.startStruct(.{ .whitespace_style = .{ .fields = 2 } });
            try container.field("a", 1, .{});
            try container.field("b", 2, .{});
            try container.finish();
            if (whitespace) {
        ...
        {
            var container = try s.startTuple(.{ .whitespace_style = .{ .fields = 2 } });
            try container.field(1, .{});
            try container.field(2, .{});
            try container.finish();
            if (whitespace) {
        ...
        {
            var container = try s.startStruct(.{ .whitespace_style = .{ .fields = 3 } });
            try container.field("a", 1, .{});
            try container.field("b", 2, .{});
            try container.field("c", 3, .{});
            try container.finish();
        ...
        {
            var container = try s.startTuple(.{ .whitespace_style = .{ .fields = 3 } });
            try container.field(1, .{});
            try container.field(2, .{});
            try container.field(3, .{});
            try container.finish();
...
test "std.zon stringify utf8 codepoints" {
    ...
    try s.codePoint('⚡');
    try std.testing.expectEqualStrings("'\\xe2\\x9a\\xa1'", aw.getWritten());
    aw.clearRetainingCapacity();
    ...
    // Invalid codepoint
    try std.testing.expectError(error.InvalidCodepoint, s.codePoint(0x110000 + 1));
    ...
    try std.testing.expectEqualStrings(".{ .c = '\\xe2\\x9a\\xa1' }", aw.getWritten());
    aw.clearRetainingCapacity();
...
test "std.zon depth limits" {
    ...
    // Max depth on other parts of the lower level API
    {
        ...
        var wip_struct = try s.startStruct(.{});
        ...
        try wip_struct.finish();

        var t = try s.startTuple(.{});
