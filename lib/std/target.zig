...
pub const Target = struct {
    ...
    pub const Cpu = struct {
        ...
        pub const Arch = enum {
            ...
            /// deprecated: use std.elf.EM.fromTargetCpuArch instead
            pub const toElfMachine = "read the doc comment of this declaration";
            /// deprecated: use std.coff.MachineType.fromTargetCpuArch instead
            pub const toCoffMachine = "read the doc comment of this declaration";
