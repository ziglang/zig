...
fn getZigArgs(compile: *Compile, fuzz: bool) ![][]const u8 {
    ...
    for (b.search_methods.items) |search| {
        ...
        if (search.libraries(b)) |libraries_lazy_path| {
            const libraries_path = libraries_lazy_path.getPath3(b, step);
        ...
        if (search.includes(b)) |includes_lazy_path| {
            const includes_path = includes_lazy_path.getPath3(b, step);
