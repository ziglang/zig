...
generated_header_text: ?[]const u8,
...
pub const Options = struct {
    ...
    generated_header_text: ?[]const u8 = null,
};
...
pub fn create(owner: *std.Build, options: Options) *ConfigHeader {
    ...
    config_header.* = .{
        ...
        .generated_header_text = options.generated_header_text,
...
fn make(step: *Step, options: Step.MakeOptions) !void {
    ...
    man.hash.addOptionalBytes(config_header.generated_header_text);
    ...
    if (config_header.generated_header_text) |text| {
        ...
        switch (config_header.style) {
            ...
            .blank => @panic("`generated_header_text` can't be `null` for `.blank` style"),
        }
    }
