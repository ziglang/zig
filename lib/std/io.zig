...
pub fn GenericReader(
    ...
    return struct {
        ...
        ) (Error || error{StreamTooLong} || Allocator.Error)!void {
        ...
        pub inline fn readAllAlloc(
            ...
            allocator: Allocator,
            max_size: usize,
        ) (Error || error{StreamTooLong} || Allocator.Error)![]u8 {
        ...
        pub inline fn readUntilDelimiterArrayList(
            ...
            delimiter: u8,
            max_size: usize,
        ) (NoEofError || error{StreamTooLong} || Allocator.Error)!void {
        ...
        pub inline fn readUntilDelimiterAlloc(
            ...
            delimiter: u8,
            max_size: usize,
        ) (NoEofError || error{StreamTooLong} || Allocator.Error)![]u8 {
