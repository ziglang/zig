...
pub fn GeneralPurposeAllocator(comptime config: Config) type {
    ...
    return struct {
        ...
        fn searchBucket(
            ...
            const search_page: [*]align(page_size) u8 = @ptrFromInt(mem.alignBackward(usize, addr, pageSize()));
        ...
        fn createBucket(self: *Self, size_class: usize) Error!*BucketHeader {
            const page = try self.backing_allocator.alignedAlloc(u8, page_size, pageSize());
