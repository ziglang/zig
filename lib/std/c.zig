...
pub extern "c" fn pipe2(fds: *[2:0]fd_t, flags: u32) c_int;
pub extern "c" fn mkdir(path: [*:0]const u8, mode: c_uint) c_int;
pub extern "c" fn symlink(existing: [*:0]const u8, new: [*:0]const u8) c_int;
pub extern "c" fn rename(old: [*:0]const u8, new: [*:0]const u8) c_int;
pub extern "c" fn chdir(path: [*:0]const u8) c_int;
pub extern "c" fn execve(path: [*:0]const u8, argv: [*]const ?[*]const u8, envp: [*]const ?[*]const u8) c_int;
...
// Deprecated
pub extern "c" fn futimes(fd: fd_t, times: *[2:0]timeval) c_int;
pub extern "c" fn utimes(path: [*:0]const u8, times: *[2:0]timeval) c_int;

pub extern "c" fn utimensat(dirfd: fd_t, pathname: [*:0]const u8, times: *[2:0]timespec, flags: u32) c_int;
