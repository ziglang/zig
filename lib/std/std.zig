...
pub const AutoHashSet = hash_set.AutoHashSet;
pub const AutoHashSetUnmanaged = hash_set.AutoHashSetUnmanaged;
...
pub const HashSetUnmanaged = hash_set.HashSetUnmanaged;
...
pub const StringHashSet = hash_set.StringHashSet;
pub const StringHashSetUnmanaged = hash_set.StringHashSetUnmanaged;
