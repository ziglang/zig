...
test sqrt32 {
    ...
    try testing.expectApproxEqAbs(2.3271174, b.re, epsilon);
    try testing.expectApproxEqAbs(0.6445742, b.im, epsilon);
}
...
test sqrt64 {
    ...
    try testing.expectApproxEqAbs(2.3271175190399496, b.re, epsilon);
    try testing.expectApproxEqAbs(0.6445742373246469, b.im, epsilon);
}
