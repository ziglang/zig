...
/// variable-length option data, see getsockoptVariable().
pub fn getsockopt(fd: socket_t, level: i32, optname: u32, opt: []u8) GetSockOptError!void {
    const returned = try getsockoptVariable(fd, level, optname, opt);
...
pub fn getsockoptVariable(fd: socket_t, level: i32, optname: u32, opt: []u8) GetSockOptError![]u8 {
