...
pub const ioctl_request = extern enum(c_uint) {
    ...
    TIOCGPGRP = 0x540F,
    TIOCSPGRP = 0x5410,
    TIOCOUTQ = if (is_mips) 0x7472 else 0x5411,
    TIOCSTI = 0x5412,
    TIOCGWINSZ = if (is_mips) 0x40087468 else 0x5413,
    TIOCSWINSZ = if (is_mips) 0x80087467 else 0x5414,
    TIOCMGET = 0x5415,
    TIOCMBIS = 0x5416,
    TIOCMBIC = 0x5417,
    TIOCMSET = 0x5418,
...
pub const VMIN: cc_t = if (is_mips) 6 else 4;
pub const VTIME: cc_t = 5;
pub const VEOL2: cc_t = if (is_mips) 16 else 6;
pub const VSWTC: cc_t = 7;
pub const VSWTCH: cc_t = 7;
...
pub const VEOF: cc_t = if (is_mips) 4 else 16;
pub const VEOL: cc_t = if (is_mips) 11 else 17;
