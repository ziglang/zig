...
pub fn sigprocmask(how: u2, noalias set: ?*const sigset_t, noalias oldset: ?*sigset_t) usize {
    return syscall4(.rt_sigprocmask, how, @ptrToInt(set), @ptrToInt(oldset), NSIG / 8);
}
