    ...
    window.addEventListener('error', function(ev) {
        ...
        if ((typeof error) === "object" && error !== null) {
            ...
            if ((typeof error.message) === "string") {
                msg.appendChild(document.createTextNode("Error: " + error.message));
            } else {
                msg.appendChild(document.createTextNode("Error: " + ev.message));
            }
            ...
            node.appendChild(document.createTextNode("Error: " + ev.message));
        }
        
        document.getElementById("sidebarWarning").appendChild(node);
    }, false);
