...
pub fn Atomic(comptime T: type) type {
    return extern struct {
        ...
        /// Perform a strong atomic compare exchange operation.
        ///
        ...
        pub inline fn compareAndSwap(
            ...
            comptime validateCompareAndSwapOrdering(success, failure);
            return @cmpxchgStrong(T, &self.value, compare, exchange, success, failure);
        }

        /// Perform a weak atomic compare exchange operation.
        ///
        ...
        fn validateCompareAndSwapOrdering(
            comptime success: Ordering,
            comptime failure: Ordering,
        ) void {
