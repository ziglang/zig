...
test "i_number_too_big_neg_int.json" {
    any("[-123123123123123123123123123123]");
}
test "i_number_too_big_pos_int.json" {
    any("[100000000000000000000]");
}
...
test "i_string_UTF-16LE_with_BOM.json" {
    any("\xff\xfe[\x00\"\x00\xe9\x00\"\x00]\x00");
}
test "i_string_UTF-8_invalid_sequence.json" {
    any("[\"\xe6\x97\xa5\xd1\x88\xfa\"]");
}
...
test "n_object_emoji.json" {
    err("{\xf0\x9f\x87\xa8\xf0\x9f\x87\xad}");
}
...
test "y_object_extreme_numbers.json" {
    ok("{ \"min\": -1.0e+28, \"max\": 1.0e+28 }");
}
test "y_object_long_strings.json" {
    ok("{\"x\":[{\"id\": \"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\"}], \"id\": \"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\"}");
}
test "y_object_simple.json" {
    ok("{\"a\":[]}");
}
test "y_object_string_unicode.json" {
    ok("{\"title\":\"\\u041f\\u043e\\u043b\\u0442\\u043e\\u0440\\u0430 \\u0417\\u0435\\u043c\\u043b\\u0435\\u043a\\u043e\\u043f\\u0430\" }");
}
...
test "y_string_unicode_2.json" {
    ok("[\"\xe2\x8d\x82\xe3\x88\xb4\xe2\x8d\x82\"]");
}
...
test "y_string_utf8.json" {
    ok("[\"\xe2\x82\xac\xf0\x9d\x84\x9e\"]");
}
