...
pub const LazyPath = struct {
    ...
    pub fn dirname(self: LazyPath) LazyPath {
        return .{
            ...
            .path = switch (self.root) {
                .generated => self.path, // TODO(lacc97): do this the right way by path manipulation
            ...
            .root = switch (self.root) {
                ...
                .generated => |gen| .{
                    .generated = .{ .generated = gen.generated, .up = gen.up + 1 },
                },
            },
        };
    }
    ...
    pub fn addStepDependencies(self: LazyPath, other_step: *Step) void {
        switch (self.root) {
            .build, .cwd => {},
            .generated => |gen| other_step.dependOn(gen.generated.step),
        }
    }
    ...
    pub fn getPath2(self: LazyPath, src_builder: *Build, asking_step: ?*Step) []const u8 {
        switch (self.root) {
            ...
            .generated => |gen| { // TODO(lacc97): get rid of this
                ...
                var p = gen.generated.path orelse {
                    std.debug.getStderrMutex().lock();
                    const stderr = std.io.getStdErr();
                    dumpBadGetPathHelp(gen.generated.step, stderr, src_builder, asking_step) catch {};
                    @panic("misconfigured build script");
                };
                var i: usize = 0;
                while (i < gen.up) : (i += 1) {
