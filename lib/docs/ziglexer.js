...
//a real slow and stupid way of doing this
function generate_html_for_src(src) {
    ...
    for (let i = 0; i < src.length; i++) {
        ...
        for (let z = 0; z < toks.length; z++) {
            ...
            if (t.loc.start <= i && t.loc.end >= i) {
                switch (t.tag) {
                    case Tag.invalid:
                    case Tag.identifier:
                    case Tag.eof:

                    case Tag.number_literal:
                    case Tag.doc_comment:
                    case Tag.container_doc_comment:
                    case Tag.invalid_periodasterisks:
                    case Tag.bang:
                    case Tag.pipe:
                    case Tag.pipe_pipe:
                    case Tag.pipe_equal:
                    case Tag.equal:
                    case Tag.equal_equal:
                    case Tag.equal_angle_bracket_right:
                    case Tag.bang_equal:
                    case Tag.l_paren:
                    case Tag.r_paren:
                    case Tag.semicolon:
                    case Tag.percent:
                    case Tag.percent_equal:
                    case Tag.l_brace:
                    case Tag.r_brace:
                    case Tag.l_bracket:
                    case Tag.r_bracket:
                    case Tag.period:
                    case Tag.period_asterisk:
                    case Tag.ellipsis2:
                    case Tag.ellipsis3:
                    case Tag.caret:
                    case Tag.caret_equal:
                    case Tag.plus:
                    case Tag.plus_plus:
                    case Tag.plus_equal:
                    case Tag.plus_percent:
                    case Tag.plus_percent_equal:
                    case Tag.plus_pipe:
                    case Tag.plus_pipe_equal:
                    case Tag.minus:
                    case Tag.minus_equal:
                    case Tag.minus_percent:
                    case Tag.minus_percent_equal:
                    case Tag.minus_pipe:
                    case Tag.minus_pipe_equal:
                    case Tag.asterisk:
                    case Tag.asterisk_equal:
                    case Tag.asterisk_asterisk:
                    case Tag.asterisk_percent:
                    case Tag.asterisk_percent_equal:
                    case Tag.asterisk_pipe:
                    case Tag.asterisk_pipe_equal:
                    case Tag.arrow:
                    case Tag.colon:
                    case Tag.slash:
                    case Tag.slash_equal:
                    case Tag.comma:
                    case Tag.ampersand:
                    case Tag.ampersand_equal:
                    case Tag.question_mark:
                    case Tag.angle_bracket_left:
                    case Tag.angle_bracket_left_equal:
                    case Tag.angle_bracket_angle_bracket_left:
                    case Tag.angle_bracket_angle_bracket_left_equal:
                    case Tag.angle_bracket_angle_bracket_left_pipe:
                    case Tag.angle_bracket_angle_bracket_left_pipe_equal:
                    case Tag.angle_bracket_right:
                    case Tag.angle_bracket_right_equal:
                    case Tag.angle_bracket_angle_bracket_right:
                    case Tag.angle_bracket_angle_bracket_right_equal:
                    case Tag.tilde:
                        color = "black";
                        break;
                    case Tag.keyword_addrspace:
                    case Tag.keyword_align:
                    case Tag.keyword_allowzero:
                    case Tag.keyword_anyframe:
                    case Tag.keyword_anytype:
                    case Tag.keyword_asm:
                    case Tag.keyword_async:
                    case Tag.keyword_await:
                    case Tag.keyword_break:
                    case Tag.keyword_callconv:
                    case Tag.keyword_catch:
                    case Tag.keyword_comptime:
                    case Tag.keyword_const:
                    case Tag.keyword_defer:
                    case Tag.keyword_continue:
                    case Tag.keyword_enum:
                    case Tag.keyword_errdefer:
                    case Tag.keyword_error:
                    case Tag.keyword_export:
                    case Tag.keyword_extern:
                    case Tag.keyword_fn:
                    case Tag.keyword_inline:
                    case Tag.keyword_noalias:
                    case Tag.keyword_noinline:
                    case Tag.keyword_nosuspend:
                    case Tag.keyword_opaque:
                    case Tag.keyword_orelse:
                    case Tag.keyword_packed:
                    case Tag.keyword_pub:
                    case Tag.keyword_resume:
                    case Tag.keyword_linksection:
                    case Tag.keyword_struct:
                    case Tag.keyword_suspend:
                    case Tag.keyword_switch:
                    case Tag.keyword_test:
                    case Tag.keyword_threadlocal:
                    case Tag.keyword_try:
                    case Tag.keyword_union:
                    case Tag.keyword_unreachable:
                    case Tag.keyword_usingnamespace:
                    case Tag.keyword_var:
                    case Tag.keyword_volatile:
                    case Tag.keyword_while:
                        color = "blue";
                        break;

                    case Tag.keyword_continue:
                    case Tag.keyword_else:
                    case Tag.keyword_for:
                    case Tag.keyword_if:
                    case Tag.keyword_or:
                    case Tag.keyword_return:
                    case Tag.keyword_and:
                        color = "purple";
                        break;
