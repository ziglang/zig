...
pub fn main() !void {
    ...
    if (package_opt) |package| {
        ...
        const dep: std.zig.Package.Manifest.Dependency = dep: {
...
fn getDepDir(
    dep: std.zig.Package.Manifest.Dependency,
    dep_name: []const u8,
...
fn listDepHashes(parent_prefix: []const u8, manifest: std.zig.Package.Manifest) !void {
