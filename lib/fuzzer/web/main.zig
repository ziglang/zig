...
var message_buffer: std.ArrayListAlignedUnmanaged(u8, .fromByteUnits(@alignOf(u64))) = .empty;
...
var recent_coverage_update: std.ArrayListAlignedUnmanaged(u8, .fromByteUnits(@alignOf(u64))) = .empty;
